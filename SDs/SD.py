...
def generate_images(prompt, num_images=3, prompt_trial = None):
    for i in range(num_images):
        image = pipe(prompt = prompt, negative_prompt = "disfigured, deformed, ugly, blurry, low resolution, poorly drawn, unnatural, bad anatomy, photo-realistic, real human").images[0]
...
if __name__ == "__main__":
    ...
    while True:
        ...
        generated_prompt = " unproductive, winter, cold, lounging, YouTube, part-time jobs, self-doubt, frustration, motivation, Instagram study, habit change, cafe, plans unfulfilled, new home, determination, growth"
